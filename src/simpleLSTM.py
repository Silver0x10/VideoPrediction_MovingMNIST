...
class SimpleLSTM(pl.LightningModule):
    def __init__(self, params):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(4096, 2048), self.relu, nn.Linear(2048, 1024), self.relu)
        self.lstm = nn.LSTM(1024, 1024)
        self.decoder = nn.Sequential(nn.Linear(1024, 2048), self.relu, nn.Linear(
            2048, 4096), self.relu, nn.Unflatten(1, (64, 64)))
